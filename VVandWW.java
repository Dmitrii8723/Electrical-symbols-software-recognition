...
public class VVandWW {
    ...
    static double[] YlineBtoT = new double[10000];
    static double[] XlineBtoT = new double[10000];
...
//////////////////////////// WW matrixes' vector//////////////////////////////////////////////////////////////////////////
     ...
     /*   if ((ZZ[0] == max) && ((Cnew < - 10)) && (Clength < 10)&& (Clength > -10)) {
            ...
            if (((XlineBtoT[0] - (Xcircle1[0] + newDiameterSpecial / 2)) <= 15) && ((XlineBtoT[0] - (Xcircle1[0] + newDiameterSpecial / 2)) >= -15) && ((YlineBtoT[0] - (Ycircle1[0] - newDiameterSpecial / 2)) >= -15) && (YlineLtoR[0] - (Ycircle1[0] - newDiameterSpecial / 2) <= 15)) {
